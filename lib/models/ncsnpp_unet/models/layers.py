...
import numpy as np
from models.ncsnpp_unet.models.normalization import ConditionalInstanceNorm2dPlus


def get_act(model_config):
    """Get activation functions from the model_config file."""

    if model_config.nonlinearity.lower() == "elu":
        return nn.ELU()
    elif model_config.nonlinearity.lower() == "relu":
        return nn.ReLU()
    elif model_config.nonlinearity.lower() == "lrelu":
        return nn.LeakyReLU(negative_slope=0.2)
    elif model_config.nonlinearity.lower() == "swish":
        return nn.SiLU()
    else:
